...
socket.on('connect', function() { // assim que recebe o evento de 'conectado', abre um console para o usuário
...
socket.on('end', function() { // se o comando de finalização do socket for executado, escutar pelo evento de fechamento normal do socket originado do servidor
	console.log('Adeus...');
	process.exit(1);
});
